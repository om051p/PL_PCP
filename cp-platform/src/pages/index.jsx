...
import {
  ...
  ANODE_SPECS,
  CABLE_SPECS,
  BOM_ALLOWED_STATUSES,
  getSoilClassification,
  STANDARD_OPTIONS,
  getActiveStandard,
} from '../constants/index.js'
import { generateBOM } from '../engine/rules/bomEngine.js'
// Reporting imports use dynamic import() for code-splitting (see PageReport, PageImport)
import {
  Building2,
  Route,
  Zap,
...
// ─── Design Standard Info Box (dynamic formula based on active standard) ─────
