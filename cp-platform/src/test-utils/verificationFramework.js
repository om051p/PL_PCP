  ...
  const datasetsInput = {
    ...
    dataset3: {
      ...
      expected: {
        ...
        totalCircuitResistanceOhm: 8.098,
        minTRVoltage: 325.9,
    ...
    dataset4: {
      ...
      expected: {
        ...
        totalCircuitResistanceOhm: 1.122,
        minTRVoltage: 12.22,
    ...
    dataset6: {
      ...
      expected: {
        ...
        negMainCableResOhm: 0.1291,
        totalCableResOhm: 0.2553,
        backEMFResistanceOhm: 0.04,
        totalCircuitResistanceOhm: 0.4639,
        minTRVoltage: 25.19,
    ...
    dataset7: {
      ...
      expected: {
        ...
        totalCircuitResistanceOhm: 4.966,
        minTRVoltage: 25.83,
