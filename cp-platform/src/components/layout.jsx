...
const PAGE_META = {
  ...
  pipeline: {
    ...
    sub: 'Geometry, operating conditions, soil resistivity',
  },
  current: {
    title: 'Current Requirement',
    sub: 'Protection current calculation with temperature correction',
  },
  groundbed: {
    title: 'Groundbed Design',
    sub: 'Anode bed configuration and resistance calculations',
  },
  ...
  validation: {
    ...
    sub: 'Automated PASS/FAIL checks with engineering insights',
  },
  optimizer: { title: 'Design Optimizer', sub: 'Alternative designs with trade-off analysis' },
  bom: {
    title: 'Bill of Materials',
    sub: 'Auto-generated material quantities (requires Approved status)',
  },
  report: { title: 'Summary Report', sub: 'Consolidated engineering design summary' },
  import: {
    title: 'Import from Excel',
    sub: 'Upload PCP.xlsx or CP Designer export to populate project data',
  },
}
