...
| DM-003 | Distributed Anode Groundbed | 🔲 Planned | Medium | DM-004 (multi-segment) |
| DM-004 | Multi-Segment Pipeline Support | 🔲 Planned | Medium | — |
...
| RPT-005 | CSV BOM Export | 🔲 Planned | Low |
...
| Ticket | Feature | Status | Effort |
|--------|---------|--------|--------|
| QA-001 | Unit Tests: Calculations | 🔲 Planned | Medium |
| QA-002 | Unit Tests: Rules Engine | 🔲 Planned | Medium |
| QA-003 | Unit Tests: BOM Engine | 🔲 Planned | Medium |
| QA-004 | Unit Tests: Store | 🔲 Planned | Medium |
| QA-005 | Integration Tests | 🔲 Planned | Medium |
| QA-006 | E2E Tests (Playwright) | 🔲 Planned | High |
| QA-007 | CI Pipeline (GitHub Actions) | 🔲 Planned | Low |
| QA-008 | Coverage Thresholds | 🔲 Planned | Low |
