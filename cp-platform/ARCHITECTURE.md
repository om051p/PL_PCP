...
| **Routing** | Manual page routing via Zustand store (`ui.activePage`) |
...
| No Unit Tests | Critical | 345 lines of calculations untested |
| No Integration Tests | High | No CI verification |
| Single Segment | Medium | `pipelineSegments[0]` everywhere |
| Revision Deep Clones | Medium | Storage grows quadratically |
| Zod Unused | Low | Declared but not used |
| No Error Boundaries | Medium | Crashes lose unsaved work |
...
| 2.2 | **Unit Test Suite** (Vitest) | Confidence in formulas |
| 2.3 | **Integration Tests** (Playwright) | E2E verification |
| 2.4 | **CI/CD Pipeline** (GitHub Actions) | Automated quality gates |
| 2.5 | **Error Boundaries + Auto-Save** | Prevent data loss |
...
| 3.2 | **Multi-Segment Pipeline Support** | Real-world modeling |
| 3.3 | **Revision Compression** | Storage efficiency |
| 3.4 | **Undo/Redo** | UX improvement |
| 3.5 | **Distributed Anode Mode** | New capability |
| 3.6 | **Tank Bottom ICCP Mode** | New capability |
...
| 4.2 | **Zod Schema Validation** | Runtime validation |
| 4.3 | **React Router** | Deep linking |
| 4.4 | **PWA Support** | Offline capability |
| 4.5 | **Dark Mode** | UX polish |
